...
type NetworkProtocol interface {
	...
	// is complete and that all the information we need about the packet is in the
	// PacketBuffer. This function may be called from anywhere in the stack
	// where a received pkt and associated route are available.
