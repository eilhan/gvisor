...
var globalData struct {
	// files is a well-ordered set of files calculated at startup.
	files []string

	// syntheticPCs are a well-ordered set of PCs calculated at startup, where
	// the PC at syntheticPCs[i][j] corresponds to file i, block j.
	syntheticPCs [][]uint64
}
